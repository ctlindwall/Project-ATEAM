...
public class Main extends Application {
	...
	/**
	 * This method creates the scene for adding a question. The user is prompted to
	 * enter the question itself, the multiple choice options, a picture image, the
	 * topic it is associated with, and the correct answer. This question will be
	...
	/**
	 * Just a lil method that lets the user know their question was successfully
	 * added.
	 * 
	 * @param primaryStage
	 */
	 ...
	 * each question the number of questions that the user requested.
	 * 
	 * @param primaryStage
	 * @param quizQuestions
	 */
	...
	/**
	 * This method presents a new stage that will tell the user the final results of
	 * the quiz. It will display the score and give the user the option to take it
	 * again or go back to the main page.
	 * 
	 * @param primaryStage
	 * @param numRight
